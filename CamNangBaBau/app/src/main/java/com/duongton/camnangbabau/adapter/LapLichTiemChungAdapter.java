...
public class LapLichTiemChungAdapter extends BaseAdapter {
    private ArrayList<LapLich> arrayList;
    private LayoutInflater inflater;
    private OnItemClickDeleteListener onItemClickDeleteListener;

    public LapLichTiemChungAdapter(ArrayList<LapLich> arrayList) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if(view ==null){
            holder = new Holder();
            view = inflater.inflate(R.layout.list_view_item_laplich_tiemchung,viewGroup, false);
