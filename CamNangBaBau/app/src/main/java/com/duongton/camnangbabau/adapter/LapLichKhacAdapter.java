...
public class LapLichKhacAdapter extends BaseAdapter {
    private ArrayList<LapLich> arrayList;
    private LayoutInflater inflater;
    private OnItemClickDeleteListener onItemClickDeleteListener;

    public LapLichKhacAdapter(ArrayList<LapLich> arrayList) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if(view ==null){
            holder = new Holder();
            view = inflater.inflate(R.layout.fragment_laplich_khac,viewGroup, false);
